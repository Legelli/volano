...
\begin{itemize}
	...
	\item $r$: raggio del dischetto attaccato al volano attorno al quale si avvolge il filo;
	\item $R$: distanza tra l'asse di rotazione del volano e il centro di massa dei bulloni;
	\item $g$: accelerazione di gravità, data, in questo caso, dal valore senza incertezza di \SI{9.803}{m/s^2}. 
\end{itemize}
