...
Con l'approssimazione $\Delta h / h = \SI{0.059 \pm 0.00286}{}$, dove l'incertezza è la deviazione standard della media, vale la relazione
\begin{equation}
...
\begin{align}
	\sigma_{M_a} &= M_a \sqrt{ \left( \frac{ \sigma_{mgr\Delta h/h}}{mgr \Delta h / h} \right)^2 + \left( \frac{ \sigma_{2-\Delta h / h}}{2 - \Delta h/h} \right)^2 } \notag \\
		&= M_a \sqrt{ \left( \frac{ \left( g r \frac{ \Delta h }{h} \right) ^2 \sigma_m^2 + \left( m g \frac{ \Delta h}{h} \right)^2 \sigma_r^2 + \left( m g r \right)^2 \sigma_{\Delta h /h} }{m g r \Delta h / h} \right)^2 + \left( \frac{ \sigma_{\Delta h / h}}{2 - \Delta h / h} \right)^2 };
\end{align} svolgendo i calcoli si raggiunge la miglior stima del momento d'attrito pari a
\begin{equation}
\boxed{\bf{M_a = \SI{0.0018 \pm 0.0004}{N m}}}.
\end{equation}
